...
//http://placehold.it/150x150
    function addAccordionToTabs(n, result) {
        ...
        $('#tabs-' + result.Type).append('<div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 pic-container"><img class="img-responsive" src="http://placehold.it/150x150"><span class="caption">' + result.Name + '</span></div>');
